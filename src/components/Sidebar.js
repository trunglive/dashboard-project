    ...
    return (
      <div className="sidebar">
        ...
        <div className="sidebar__hours">
          <img className="sidebar__icon" src="/icons/hours.svg" />
          <p>hours</p>
        </div>
        ...
        <div className="sidebar__people">
          <img className="sidebar__icon" src="/icons/people.svg" />
          <p>people</p>
        </div>
        <div className="sidebar__reports">
          <img className="sidebar__icon" src="/icons/reports.svg" />
          <p>reports</p>
        </div>
        ...
        <div className="sidebar__settings">
          <img className="sidebar__icon" src="/icons/settings.svg" />
        </div>
        <div className="sidebar__notifications">
          <img className="sidebar__icon" src="/icons/notifications.svg" />
        </div>
        <div className="sidebar__support">
          <img className="sidebar__icon" src="/icons/support.svg" />
        </div>
        <div className="sidebar__personal-settings">
          <img className="sidebar__icon" src="/icons/personal-settings.svg" />
        </div>
      </div>
    );
  }
